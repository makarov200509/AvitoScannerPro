      ...
      <div class="modal-body">
        <div class="help-section">
          ...
          <div class="help-section-content">
            ...
            <p>2. Выберите город из списка</p>
        ...
        <div class="help-section">
          ...
          <div class="help-section-content">
            <p>Специальный режим для упрощения поиска и анализа айфонов:</p>
            <ul>
        ...
        <div class="help-section">
          ...
          <div class="help-section-content">
            ...
            <ul>
              <li>История поисков — результаты обычного поиска</li>
              <li>История анализов — результаты анализа рынка</li>
            </ul>
        ...
        <div class="help-section">
          ...
          <div class="help-section-content">
            ...
            <ul>
              <li>Сменить пароль — изменить пароль от аккаунта</li>
              <li>Статистика — показать/скрыть блок статистики</li>
              <li>Инструкция — открыть это окно</li>
              <li>Выйти — завершить сессию</li>
              <li>Удалить аккаунт — безвозвратное удаление всех данных</li>
            </ul>
          </div>
        </div>
